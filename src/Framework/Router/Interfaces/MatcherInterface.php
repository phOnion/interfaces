 ...
 *
 * Implementations should be responsible for performing
 * matching from a generated pattern (possibly from a
 * paired parser) against the provided path
 *
 * @package Onion\Framework\Router\Interfaces
 */
interface MatcherInterface
{
    /**
